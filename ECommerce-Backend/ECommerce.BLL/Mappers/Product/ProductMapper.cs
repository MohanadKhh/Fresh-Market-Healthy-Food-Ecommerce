...
namespace ECommerce.BLL
{
    public static class ProductMapper
    {
        ...
        public static Product ToProductModel(this ProductWriteDto productWriteDTO) => new()
        {
            ...
            Stock = productWriteDTO.Stock,
            Unit = productWriteDTO.Unit,
            Reviews = productWriteDTO.Reviews,
            IsOrganic = productWriteDTO.IsOrganic,
            IsFeatured = productWriteDTO.IsFeatured,
            CreatedAt = productWriteDTO.CreatedAt == default ? DateOnly.FromDateTime(DateTime.UtcNow) : productWriteDTO.CreatedAt,
